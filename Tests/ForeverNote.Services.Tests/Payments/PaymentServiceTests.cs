...
namespace ForeverNote.Services.Payments.Tests
{
    [TestClass()]
    public class PaymentServiceTests
    {
        ...
        public void ProcessPayment_NotFoundPaymentMethod_ThrowException()
        {
            ...
            _pluginFinder.Setup(c => c.GetPluginDescriptorBySystemName<IPaymentMethod>(It.IsAny<string>(), LoadPluginsMode.InstalledOnly)).Returns(() => descriptorMock.Object);
            Assert.ThrowsExceptionAsync<ForeverNoteException>(async ()=> await _paymentService.ProcessPayment(request));
        }
        ...
        public void PostProcessPayment_NotFoundPaymentMethod_ThrowException()
        {
            ...
            Assert.ThrowsExceptionAsync<ForeverNoteException>(async() => await _paymentService.PostProcessPayment(request), "Payment method couldn't be loaded");
        }
