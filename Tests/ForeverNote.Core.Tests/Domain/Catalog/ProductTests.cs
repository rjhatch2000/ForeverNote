...
namespace ForeverNote.Core.Domain.Catalog.Tests
{
    [TestClass()]
    public class ProductTests {
        ...
        public void Entities_with_same_id_but_different_type_should_not_be_equal() {
            ...
            Assert.AreNotEqual((object)product01, (object)product02, "Entities of different types should not be equal, even if they have the same id");
        }
    }
}