...
//using ForeverNote.Api.Interfaces;
//using ForeverNote.Api.Tests.Helpers;
//using ForeverNote.Core.Data;
//using ForeverNote.Core.Domain.Catalog;
//using ForeverNote.Services.Security;
//using ForeverNote.Services.Tests;
//using ForeverNote.Web.Areas.Api.Controllers.OData;
...
//namespace ForeverNote.Api.Tests.ControllerTests
//{
//    [TestClass]
