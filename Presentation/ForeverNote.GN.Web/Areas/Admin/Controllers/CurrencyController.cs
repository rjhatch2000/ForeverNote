            ...
            if (liveRates)
            {
                try
                {
                    ...
                    if (primaryExchangeCurrency == null)
                        throw new ForeverNoteException("Primary exchange rate currency is not set");
        ...
        public async Task<IActionResult> Delete(string id)
        {
            ...
            try
            {
                if (currency.Id == _currencySettings.PrimaryStoreCurrencyId)
                    throw new ForeverNoteException(_localizationService.GetResource("Admin.Configuration.Currencies.CantDeletePrimary"));

                if (currency.Id == _currencySettings.PrimaryExchangeRateCurrencyId)
                    throw new ForeverNoteException(_localizationService.GetResource("Admin.Configuration.Currencies.CantDeleteExchange"));
