                        ...
                        {
                            {
                                ...
                                if (!(descriptor as PluginDescriptor).SupportedVersions.Contains(ForeverNoteVersion.CurrentVersion))
                                    throw new Exception($"This plugin doesn't support the current version - {ForeverNoteVersion.CurrentVersion}");
                            }
                        }
                    }
                }
