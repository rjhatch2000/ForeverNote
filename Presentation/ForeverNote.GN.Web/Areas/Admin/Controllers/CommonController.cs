...
using ForeverNote.Web.Framework.Security;
...
namespace ForeverNote.Web.Areas.Admin.Controllers
{
    ...
    public partial class CommonController : BaseAdminController
    {
        ...
        public CommonController(IPaymentService paymentService,
            ...
            ForeverNoteConfig foreverNoteConfig
            )
        {
        ...
        public IActionResult SystemInfo()
        {
            ...
            model.ForeverNoteVersion = ForeverNoteVersion.CurrentVersion;
            try
            {
        ...
        {
            return View(_foreverNoteConfig.UseRoslynScripts);
        }
