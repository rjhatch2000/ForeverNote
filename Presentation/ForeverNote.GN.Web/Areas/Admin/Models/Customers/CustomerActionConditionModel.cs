...
namespace ForeverNote.Web.Areas.Admin.Models.Customers
{
    ...
    public partial class CustomerActionConditionModel : BaseForeverNoteEntityModel
    {
        ...
        [ForeverNoteResourceDisplayName("Admin.Customers.CustomerActionCondition.Fields.Name")]
        public string Name { get; set; }

        [ForeverNoteResourceDisplayName("Admin.Customers.CustomerActionCondition.Fields.CustomerConditionTypeId")]
        public int CustomerActionConditionTypeId { get; set; }
        public IList<SelectListItem> CustomerActionConditionType { get; set; }

        [ForeverNoteResourceDisplayName("Admin.Customers.CustomerActionCondition.Fields.ConditionId")]
