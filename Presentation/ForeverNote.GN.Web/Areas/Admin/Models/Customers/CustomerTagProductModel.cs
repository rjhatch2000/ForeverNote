...
{
    public partial class CustomerTagProductModel: BaseForeverNoteEntityModel
    {
        [ForeverNoteResourceDisplayName("Admin.Customers.CustomerTags.Products.Fields.Name")]
        
        public string Name { get; set; }

        [ForeverNoteResourceDisplayName("Admin.Customers.CustomerTags.Products.Fields.DisplayOrder")]
