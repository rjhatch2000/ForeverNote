...
{
    public partial class ProductListModel : BaseForeverNoteModel
    {
        ...
        [ForeverNoteResourceDisplayName("Admin.Catalog.Products.List.SearchIncludeSubCategories")]
        ...
        [ForeverNoteResourceDisplayName("Admin.Catalog.Products.List.SearchWarehouse")]
        ...
        [ForeverNoteResourceDisplayName("Admin.Catalog.Products.List.SearchPublished")]
        public int SearchPublishedId { get; set; }

        [ForeverNoteResourceDisplayName("Admin.Catalog.Products.List.GoDirectlyToSku")]
