...
namespace ForeverNote.Web.Models.ShoppingCart
{
    public partial class ShoppingCartModel : BaseForeverNoteModel
    {
        ...
        public partial class CheckoutAttributeModel : BaseForeverNoteEntityModel
        {
        ...
        public partial class CheckoutAttributeValueModel : BaseForeverNoteEntityModel
        {
            public string Name { get; set; }
        ...
        public partial class DiscountBoxModel: BaseForeverNoteModel
        {
            ...
            public class DiscountInfoModel : BaseForeverNoteEntityModel
            {
                public string CouponCode { get; set; }
            }
        }

        public partial class GiftCardBoxModel : BaseForeverNoteModel
        {
            public bool Display { get; set; }
            public string Message { get; set; }
            public bool IsApplied { get; set; }
        ...
        public partial class OrderReviewDataModel : BaseForeverNoteModel
        {
