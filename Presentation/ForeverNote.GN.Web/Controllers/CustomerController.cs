...
using ForeverNote.Web.Commands.Models.Customers;
...
namespace ForeverNote.Web.Controllers
{
    public partial class CustomerController : BasePublicController
    {
        ...
        private readonly IForeverNoteAuthenticationService _authenticationService;
        ...
        public CustomerController(
            IForeverNoteAuthenticationService authenticationService,
        ...
        public virtual async Task<IActionResult> Logout([FromServices] StoreInformationSettings storeInformationSettings)
        {
            ...
            if (storeInformationSettings.DisplayEuCookieLawWarning)
            {
                ...
                TempData["ForeverNote.IgnoreEuCookieLawWarning"] = true;
            }
            return RedirectToRoute("HomePage");
        }
