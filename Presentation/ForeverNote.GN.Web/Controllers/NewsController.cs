...
using ForeverNote.Web.Framework.Mvc.Rss;
...
using ForeverNote.Web.Features.Models.News;
    ...
    public partial class NewsController : BasePublicController
    {
        ...
        public virtual async Task<IActionResult> NewsCommentAdd(string newsItemId, NewsItemModel model, bool captchaValid)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                TempData["ForeverNote.news.addcomment.result"] = _localizationService.GetResource("News.Comments.SuccessfullyAdded");
