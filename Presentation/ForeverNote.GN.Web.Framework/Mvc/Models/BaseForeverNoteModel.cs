...
namespace ForeverNote.Web.Framework.Mvc.Models
{
    ...
    /// </summary>
    public partial class BaseForeverNoteModel
    {
        #region Ctor

        public BaseForeverNoteModel()
        {
    ...
    /// <summary>
    /// Represents base forevernote entity model
    /// </summary>
    public partial class BaseForeverNoteEntityModel : BaseForeverNoteModel
    {
        /// <summary>
