...
namespace ForeverNote.Web.Framework.Mvc.Razor
{
    /// <summary>
    /// Web view page
    /// </summary>
    /// <typeparam name="TModel">Model</typeparam>
    public abstract class ForeverNotePage<TModel> : Microsoft.AspNetCore.Mvc.Razor.RazorPage<TModel>
    {
        ...
        public int GetSelectedTabIndex()
        {
            ...
            //"SetSelectedTabIndex" method of \Administration\Controllers\BaseForeverNoteController.cs
            int index = 0;
            string dataKey = "ForeverNote.selected-tab-index";
