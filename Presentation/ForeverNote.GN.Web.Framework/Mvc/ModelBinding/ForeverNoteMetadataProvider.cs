...
namespace ForeverNote.Web.Framework.Mvc.ModelBinding
{
    ...
    /// </summary>
    public class ForeverNoteMetadataProvider : IDisplayMetadataProvider
    {
        /// <summary>
        ...
        public void CreateDisplayMetadata(DisplayMetadataProviderContext context)
        {
            ...
            foreach (var additionalValue in additionalValues)
            {
                if (context.DisplayMetadata.AdditionalValues.ContainsKey(additionalValue.Name))
                    throw new ForeverNoteException($"There is already an attribute with the name {additionalValue.Name} on this model");
