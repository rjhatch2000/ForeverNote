...
using ForeverNote.Core.Caching.Message;
using ForeverNote.Core.Caching.Redis;
...
using ForeverNote.Web.Framework.TagHelpers;
...
using ForeverNote.Services.Courses;
using ForeverNote.Services.Customers;
using ForeverNote.Services.Directory;
using ForeverNote.Services.Discounts;
using ForeverNote.Services.Documents;
using ForeverNote.Services.ExportImport;
...
using ForeverNote.Services.PushNotifications;
...
namespace ForeverNote.Web.Framework.Infrastructure
{
    /// <summary>
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, ForeverNoteConfig config)
        {
        ...
        private void RegisterCache(ContainerBuilder builder, ForeverNoteConfig config)
        {
        ...
        private void RegisterMachineNameProvider(ContainerBuilder builder, ForeverNoteConfig config)
        {
        ...
        {
            builder.RegisterType<CookieAuthenticationService>().As<IForeverNoteAuthenticationService>().InstancePerLifetimeScope();
        ...
        private void RegisterMediaService(ContainerBuilder builder, ForeverNoteConfig config)
        {
