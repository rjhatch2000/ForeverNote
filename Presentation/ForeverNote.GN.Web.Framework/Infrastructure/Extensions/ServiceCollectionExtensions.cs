...
namespace ForeverNote.Web.Framework.Infrastructure.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        {
            //add ForeverNoteConfig configuration parameters
            services.ConfigureStartupConfig<ForeverNoteConfig>(configuration.GetSection("ForeverNote"));
        ...
        /// </summary>
        /// <param name="services">Collection of service descriptors</param>
        public static void AddAntiForgery(this IServiceCollection services, ForeverNoteConfig config)
        {
            //override cookie name
            services.AddAntiforgery(options =>
            {
                options.Cookie = new CookieBuilder() {
                    Name = ".ForeverNote.Antiforgery"
                };
        ...
        /// </summary>
        /// <param name="services">Collection of service descriptors</param>
        public static void AddHttpSession(this IServiceCollection services, ForeverNoteConfig config)
        {
            services.AddSession(options =>
            {
                options.Cookie = new CookieBuilder() {
                    Name = ".ForeverNote.Session",
                    HttpOnly = true,
                };
                if (DataSettingsHelper.DatabaseIsInstalled())
                {
        ...
        /// </summary>
        /// <param name="services">Collection of service descriptors</param>
        public static void AddForeverNoteDataProtection(this IServiceCollection services, ForeverNoteConfig config)
        {
            if (config.PersistKeysToRedis)
            {
                services.AddDataProtection(opt => opt.ApplicationDiscriminator = "forevernote")
        ...
        /// </summary>
        /// <param name="services">Collection of service descriptors</param>
        public static void AddForeverNoteAuthentication(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            {
                options.DefaultScheme = ForeverNoteCookieAuthenticationDefaults.AuthenticationScheme;
                options.DefaultSignInScheme = ForeverNoteCookieAuthenticationDefaults.ExternalAuthenticationScheme;
            });

            //add main cookie authentication
            authenticationBuilder.AddCookie(ForeverNoteCookieAuthenticationDefaults.AuthenticationScheme, options =>
            {
                options.Cookie.Name = ForeverNoteCookieAuthenticationDefaults.CookiePrefix + ForeverNoteCookieAuthenticationDefaults.AuthenticationScheme;
                options.Cookie.HttpOnly = true;
                options.LoginPath = ForeverNoteCookieAuthenticationDefaults.LoginPath;
                options.AccessDeniedPath = ForeverNoteCookieAuthenticationDefaults.AccessDeniedPath;

                options.Cookie.SecurePolicy = config.CookieSecurePolicyAlways ? CookieSecurePolicy.Always : CookieSecurePolicy.SameAsRequest;
            });

            //add external authentication
            authenticationBuilder.AddCookie(ForeverNoteCookieAuthenticationDefaults.ExternalAuthenticationScheme, options =>
            {
                options.Cookie.Name = ForeverNoteCookieAuthenticationDefaults.CookiePrefix + ForeverNoteCookieAuthenticationDefaults.ExternalAuthenticationScheme;
                options.Cookie.HttpOnly = true;
                options.LoginPath = ForeverNoteCookieAuthenticationDefaults.LoginPath;
                options.AccessDeniedPath = ForeverNoteCookieAuthenticationDefaults.AccessDeniedPath;
                options.Cookie.SecurePolicy = config.CookieSecurePolicyAlways ? CookieSecurePolicy.Always : CookieSecurePolicy.SameAsRequest;
        ...
        public static IMvcBuilder AddForeverNoteMvc(this IServiceCollection services, IConfiguration configuration)
        {
            //add basic MVC feature
            var mvcBuilder = services.AddMvc(options =>
            {
                //add custom display metadata provider
                options.ModelMetadataDetailsProviders.Add(new ForeverNoteMetadataProvider());
            });
            ...
            mvcBuilder.AddFluentValidation(configuration =>
            {
                var assemblies = mvcBuilder.PartManager.ApplicationParts
                    .OfType<AssemblyPart>()
                    .Where(part => part.Name.StartsWith("ForeverNote", StringComparison.InvariantCultureIgnoreCase))
        ...
        /// </summary>
        /// <param name="services">Collection of service descriptors</param>
        public static void AddForeverNoteMiniProfiler(this IServiceCollection services)
        {
            ...
            services.AddMiniProfiler(options =>
            {
                ...
                options.ResultsAuthorize = request =>
                    !request.HttpContext.RequestServices.GetRequiredService<ForeverNoteConfig>().DisplayMiniProfilerInPublicStore ||
        ...
        /// </summary>
        /// <param name="services">Collection of service descriptors</param>
        public static void AddForeverNoteRedirectResultExecutor(this IServiceCollection services)
        {
            //we use custom redirect executor as a workaround to allow using non-ASCII characters in redirect URLs
            services.AddSingleton<IActionResultExecutor<RedirectResult>, ForeverNoteRedirectResultExecutor>();
        }
        ...
        public static void AddForeverNoteHealthChecks(this IServiceCollection services)
        {
