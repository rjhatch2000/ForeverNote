...
namespace ForeverNote.Web.Framework.TagHelpers.Admin
{
    ...
    public class LabelRequiredTagHelper : LabelTagHelper
    {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (For.Metadata.AdditionalValues.TryGetValue("ForeverNoteResourceDisplayNameAttribute", out object value))
            {
                var resourceDisplayName = value as ForeverNoteResourceDisplayNameAttribute;
