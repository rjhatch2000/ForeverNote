...
namespace ForeverNote.Services.Messages
{
    ...
    public partial class ContactAttributeService : IContactAttributeService
    {
        ...
        /// {1} : ignore ACL?
        /// </remarks>
        private const string CONTACTATTRIBUTES_ALL_KEY = "ForeverNote.contactattribute.all-{0}-{1}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        private const string CONTACTATTRIBUTES_BY_ID_KEY = "ForeverNote.contactattribute.id-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string CONTACTATTRIBUTES_PATTERN_KEY = "ForeverNote.contactattribute.";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string CONTACTATTRIBUTEVALUES_PATTERN_KEY = "ForeverNote.contactattributevalue.";
        #endregion
