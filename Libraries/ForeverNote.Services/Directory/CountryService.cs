...
namespace ForeverNote.Services.Directory
{
    ...
    public partial class CountryService : ICountryService
    {
        ...
        /// </remarks>
        private const string COUNTRIES_ALL_KEY = "ForeverNote.country.all-{0}-{1}";
        ...
        /// {0} : country ID
        /// </remarks>
        private static string COUNTRIES_BY_KEY = "ForeverNote.country.id-{0}";
        ...
        /// {0} : twoletter
        /// </remarks>
        private static string COUNTRIES_BY_TWOLETTER = "ForeverNote.country.twoletter-{0}";
        ...
        /// {0} : threeletter
        /// </remarks>
        private static string COUNTRIES_BY_THREELETTER = "ForeverNote.country.threeletter-{0}";

        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string COUNTRIES_PATTERN_KEY = "ForeverNote.country.";
