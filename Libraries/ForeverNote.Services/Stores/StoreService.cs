...
namespace ForeverNote.Services.Stores
{
    /// <summary>
    /// Store service
    /// </summary>
    public partial class StoreService : IStoreService
    {
        ...
        /// Key for caching
        /// </summary>
        private const string STORES_ALL_KEY = "ForeverNote.stores.all";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : store ID
        /// </remarks>
        private const string STORES_BY_ID_KEY = "ForeverNote.stores.id-{0}";
