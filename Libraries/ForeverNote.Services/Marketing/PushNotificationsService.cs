...
namespace ForeverNote.Services.Marketing
{
    public class PushNotificationsService : IPushNotificationsService
    {
        ...
        {
            return await Task.FromResult(_pushRegistrationRepository.Table.FirstOrDefault(x => x.UserId == customerId));
        }
        ...
        public virtual async Task<(bool, string)> SendPushNotification(string title, string text, string pictureUrl, string clickUrl, List<string> registrationIds = null)
        {
            ...
            try
            {
                ...
                {
                    await _logger.InsertLog(LogLevel.Error, "Error occured while sending push notification.", responseString);
