...
using ForeverNote.Core.Domain.Cms;
...
namespace ForeverNote.Services.Installation
{
    public partial class CodeFirstInstallationService : IInstallationService
    {
            ...
            var news = new List<NewsItem>
                                {
                                    ...
                                    {
                                         AllowComments = false,
                                         Title = "About ForeverNote",
                                         Short = "It's stable and highly usable. From downloads to documentation, www.forever-note.com offers a comprehensive base of information, resources, and support to the forever-note.community.",
                                         Full = "<p>For full feature list go to <a href=\"http://www.forever-note.com\">forever-note.com</a></p><p>Providing outstanding custom search engine optimization, web development services and e-commerce development solutions to our clients at a fair price in a professional manner.</p>",
                                         Published  = true,
                                         CreatedOnUtc = DateTime.UtcNow,
                                    },
                                    new NewsItem
                                    {
                                         AllowComments = false,
                                         Title = "ForeverNote new release!",
                                         Short = "forevernote includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included! forevernote is a fully customizable shopping cart",
                                         Full = "<p>ForeverNote includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included!</p>",
                                         Published  = true,
                                         CreatedOnUtc = DateTime.UtcNow.AddSeconds(1),
                                    },
                                    new NewsItem
                                    {
                                         ...
                                         Short = "The new forevernote store is open now! We are very excited to offer our new range of products. We will be constantly adding to our range so please register on our site.",
        ...
        protected virtual async Task InstallPolls()
        {
            var defaultLanguage = _languageRepository.Table.FirstOrDefault();
            var poll1 = new Poll {
                Name = "Do you like ForeverNote for MongoDB?",
                SystemKeyword = "",
                Published = true,
                ShowOnHomePage = true,
                DisplayOrder = 1,
