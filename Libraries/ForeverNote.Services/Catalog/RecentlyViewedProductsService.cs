...
namespace ForeverNote.Services.Catalog
{
    ...
    public partial class RecentlyViewedProductsService : IRecentlyViewedProductsService
    {
        ...
        /// {1} : number
        /// </remarks>
        private const string RECENTLY_VIEW_PRODUCTS_KEY = "ForeverNote.recentlyviewedproducts-{0}-{1}";

        /// <summary>
        /// Key pattern to clear cache
        /// {0} customer id
        /// </summary>
        private const string RECENTLY_VIEW_PRODUCTS_PATTERN_KEY = "ForeverNote.recentlyviewedproducts-{0}";
