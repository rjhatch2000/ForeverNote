...
namespace ForeverNote.Services.Catalog
{
    ...
    public partial class SpecificationAttributeService : ISpecificationAttributeService
    {
        ...
        /// {0} : sename
        /// </remarks>
        private const string SPECIFICATION_BY_SENAME = "ForeverNote.specification.sename-{0}";
        ...
        /// {0} : specification ID
        /// </remarks>
        private const string SPECIFICATION_BY_ID_KEY = "ForeverNote.specification.id-{0}";
        ...
        /// </remarks>
        private const string SPECIFICATION_BY_OPTIONID_KEY = "ForeverNote.specification.optionid-{0}";

        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string SPECIFICATION_PATTERN_KEY = "ForeverNote.specification.";
