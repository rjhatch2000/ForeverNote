...
using ForeverNote.Services.Discounts.Cache;
...
namespace ForeverNote.Services.Discounts
{
    ...
    public partial class DiscountService : IDiscountService
    {
        ...
        /// {0} : discont ID
        /// </remarks>
        private const string DISCOUNTS_BY_ID_KEY = "ForeverNote.discount.id-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// {3} : discount name
        /// </remarks>
        private const string DISCOUNTS_ALL_KEY = "ForeverNote.discount.all-{0}-{1}-{2}-{3}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string DISCOUNTS_PATTERN_KEY = "ForeverNote.discount.";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        ...
        /// Key pattern to clear cache
        /// </summary>
        private const string MANUFACTURERS_PATTERN_KEY = "ForeverNote.manufacturer.";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string CATEGORIES_PATTERN_KEY = "ForeverNote.category.";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string VENDORS_PATTERN_KEY = "ForeverNote.vendor.";
