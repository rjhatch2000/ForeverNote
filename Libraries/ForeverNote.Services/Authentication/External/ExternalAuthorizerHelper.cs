using ForeverNote.Core.Http;
using Microsoft.AspNetCore.Http;
using System.Collections.Generic;

namespace ForeverNote.Services.Authentication.External
{
    /// <summary>
    ...
    public static partial class ExternalAuthorizerHelper
    {
        ...
        /// </summary>
        private const string EXTERNAL_AUTHENTICATION_PARAMETERS = "ForeverNote.externalauth.parameters";

        /// <summary>
        /// Key for store external authentication errors to session
        /// </summary>
        private const string EXTERNAL_AUTHENTICATION_ERRORS = "ForeverNote.externalauth.errors";
