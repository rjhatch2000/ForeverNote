...
namespace ForeverNote.Services.Orders
{
    ...
    public partial class CheckoutAttributeService : ICheckoutAttributeService
    {
        ...
        /// {2} : ignore ACL?
        /// </remarks>
        private const string CHECKOUTATTRIBUTES_ALL_KEY = "ForeverNote.checkoutattribute.all-{0}-{1}-{2}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        private const string CHECKOUTATTRIBUTES_BY_ID_KEY = "ForeverNote.checkoutattribute.id-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string CHECKOUTATTRIBUTES_PATTERN_KEY = "ForeverNote.checkoutattribute.";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string CHECKOUTATTRIBUTEVALUES_PATTERN_KEY = "ForeverNote.checkoutattributevalue.";
        #endregion
