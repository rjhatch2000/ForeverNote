...
using ForeverNote.Services.ExportImport.Help;
...
namespace ForeverNote.Services.ExportImport
{
    /// <summary>
    /// Import manager
    /// </summary>
    public partial class ImportManager : IImportManager
    {
        ...
        public virtual async Task ImportProductsFromXlsx(Stream stream)
        {
            ...
            using (var xlPackage = new ExcelPackage(stream))
            {
                ...
                if (worksheet == null)
                    throw new ForeverNoteException("No worksheet found");
            ...
            using (var reader = new StreamReader(stream))
            {
                while (!reader.EndOfStream)
                {
                    ...
                    else if (tmp.Length == 4)
                    {
                        ...
                        throw new ForeverNoteException("Wrong file format");
