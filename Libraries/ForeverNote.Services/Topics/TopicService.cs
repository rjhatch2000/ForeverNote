...
namespace ForeverNote.Services.Topics
{
    /// <summary>
    /// Topic service
    /// </summary>
    public partial class TopicService : ITopicService
    {
        ...
        /// {1} : ignore ACL?
        /// </remarks>
        private const string TOPICS_ALL_KEY = "ForeverNote.topics.all-{0}-{1}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : topic ID
        /// </remarks>
        private const string TOPICS_BY_ID_KEY = "ForeverNote.topics.id-{0}";
        ...
        /// {1} : store id
        /// </remarks>
        private const string TOPICS_BY_SYSTEMNAME = "ForeverNote.topics.systemname-{0}-{1}";

        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string TOPICS_PATTERN_KEY = "ForeverNote.topics.";
