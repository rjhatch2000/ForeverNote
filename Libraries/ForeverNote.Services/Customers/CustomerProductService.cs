...
namespace ForeverNote.Services.Customers
{
    ...
    public class CustomerProductService : ICustomerProductService
    {
        ...
        /// {0} customer id
        /// </summary>
        private const string CUSTOMER_PRODUCT_KEY = "ForeverNote.product.personal-{0}";
        ...
        /// {1} - product id
        /// </summary>
        private const string CUSTOMER_PRODUCT_PRICE_KEY_ID = "ForeverNote.product.price-{0}-{1}";
