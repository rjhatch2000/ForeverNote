...
namespace ForeverNote.Services.Customers
{
    ...
    public partial class CustomerTagService : ICustomerTagService
    {
        ...
        /// {0} : customer tag Id?
        /// </remarks>
        private const string CUSTOMERTAGPRODUCTS_ROLE_KEY = "ForeverNote.customertagproducts.tag-{0}";

        private const string PRODUCTS_CUSTOMER_TAG = "ForeverNote.product.ct";
