...
namespace ForeverNote.Services.Shipping
{
    /// <summary>
    /// Shipping service
    /// </summary>
    public partial class ShippingService : IShippingService
    {
        ...
        /// {0} : warehouse ID
        /// </remarks>
        private const string WAREHOUSES_BY_ID_KEY = "ForeverNote.warehouse.id-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string WAREHOUSES_PATTERN_KEY = "ForeverNote.warehouse.";

        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string SHIPPINGMETHOD_PATTERN_KEY = "ForeverNote.shippingmethod.";

        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string PICKUPPOINTS_PATTERN_KEY = "ForeverNote.pickuppoint.";
        ...
        /// {0} : delivery date ID
        /// </remarks>
        private const string DELIVERYDATE_BY_ID_KEY = "ForeverNote.deliverydate.id-{0}";
        ...
        /// <remarks>
        /// </remarks>
        private const string DELIVERYDATE_PATTERN_KEY = "ForeverNote.deliverydate.";
            ...
            Store store = null)
        {
            ...
            if (!shippingRateComputationMethods.Any())
                throw new ForeverNoteException("Shipping rate computation method could not be loaded");
