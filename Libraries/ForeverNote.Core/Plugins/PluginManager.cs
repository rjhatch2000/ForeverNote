...
namespace ForeverNote.Core.Plugins
{
    /// <summary>
    ...
    public static class PluginManager
    {
        ...
        /// Initialize
        /// </summary>
        public static void Initialize(IMvcCoreBuilder mvcCoreBuilder, ForeverNoteConfig config)
        {
            ...
            using (new WriteLockDisposable(Locker))
            {
                ...
                try
                {
                    ...
                    foreach (var dfd in GetDescriptionFilesAndDescriptors(pluginFolder))
                    {
                        ...
                        if (!pluginDescriptor.SupportedVersions.Contains(ForeverNoteVersion.CurrentVersion, StringComparer.OrdinalIgnoreCase))
                        {
        ...
        private static Assembly AddApplicationPart(FileInfo plug, IMvcCoreBuilder mvcCoreBuilder, ForeverNoteConfig config)
        {
            if (plug.Directory == null || plug.Directory.Parent == null)
                throw new InvalidOperationException("The plugin directory for the " + plug.Name + " file exists in a folder outside of the allowed forevernote folder hierarchy");
            ...
            {
                throw new InvalidOperationException($"The plugin directory for the {plug.Name} file exists in a folder outside of the allowed forevernote folder hierarchy - exception because of {plug.FullName} - exception: {ex.Message}");
            }
        }
