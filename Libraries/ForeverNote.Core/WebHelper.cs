...
namespace ForeverNote.Core
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        public virtual bool IsPostBeingDone {
            get {
                if (_httpContextAccessor.HttpContext.Items["ForeverNote.IsPOSTBeingDone"] == null)
                    return false;

                return Convert.ToBoolean(_httpContextAccessor.HttpContext.Items["ForeverNote.IsPOSTBeingDone"]);
            }
            set {
                _httpContextAccessor.HttpContext.Items["ForeverNote.IsPOSTBeingDone"] = value;
            }
        }
